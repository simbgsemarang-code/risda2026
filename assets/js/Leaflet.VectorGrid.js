...
var Symbolizer = L.Class.extend({
	// ðŸ‚method initialize(feature: GeoJSON, pxPerExtent: Number)
	// Initializes a new Line Symbolizer given a GeoJSON feature and the
	// pixel-to-coordinate-units ratio. Internal use only.

	// ðŸ‚method render(renderer, style)
...
// ðŸ‚class PointSymbolizer
// ðŸ‚inherits CircleMarker
...
// ðŸ‚class LineSymbolizer
// ðŸ‚inherits Polyline
...
L.VectorGrid = L.GridLayer.extend({
	...
	options: {
		// ðŸ‚option rendererFactory = L.svg.tile
		// A factory method which will be used to instantiate the per-tile renderers.
		rendererFactory: L.svg.tile,

		// ðŸ‚option vectorTileLayerStyles: Object = {}
		// A data structure holding initial symbolizer definitions for the vector features.
		vectorTileLayerStyles: {},

		// ðŸ‚option interactive: Boolean = false
		// Whether this `VectorGrid` fires `Interactive Layer` events.
		interactive: false,

		// ðŸ‚option getFeatureId: Function = undefined
	...
	// ðŸ‚method setFeatureStyle(id: Number, layerStyle: L.Path Options): this
	...
	// ðŸ‚method setFeatureStyle(id: Number): this
	...
	// ðŸ‚method getDataLayerNames(): Array
...
/*
 * ðŸ‚section Extension methods
 *
 * Classes inheriting from `VectorGrid` **must** define the `_getVectorTilePromise` private method.
 *
 * ðŸ‚method getVectorTilePromise(coords: Object): Promise
...
/*
 * ðŸ‚class VectorGrid.Protobuf
 * ðŸ‚extends VectorGrid
 *
...
L.VectorGrid.Protobuf = L.VectorGrid.extend({
	...
	options: {
		...
		//
		// ðŸ‚option subdomains: String = 'abc'
		// Akin to the `subdomains` option for `L.TileLayer`.
		subdomains: 'abc',	// Like L.TileLayer
		//
		// ðŸ‚option fetchOptions: Object = {}
...
// 		this._slicer = geojsonvt(geojson, options);
	...
	// ðŸ‚method setUrl(url: String, noRedraw?: Boolean): this
...
// ðŸ‚factory L.vectorGrid.protobuf(url: String, options)
