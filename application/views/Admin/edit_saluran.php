...
<script src="https://cdn.jsdelivr.net/npm/@turf/turf@6.3.0/turf.min.js"></script>
            <form action="<?= base_url('Admin/Kecamatan/edit_simpan_saluran/' . $tabel[0]->id.'/'.$saluran[0]->id) ?>" method="POST" enctype="multipart/form-data">
            <div class="row gutters">
                <?php
                        $tab = $tabel[0];
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <?php }elseif($key == 'NO_DI') { ?>
                                         ...
                                         <input type="text" class="form-control" id="<?= $key ?>" name="<?= $key ?>" value="<?=$tabel[0]->geojson?>">
                                         ...
                                         <?php }elseif($key == 'HM') { ?>
                                         <input type="text" class="form-control" id="<?= $key ?>" name="<?= $key ?>" value="<?=$tabel[0]->HM?>">
