   ...
   <div class="col-sm-12">
                ...
                <table id="basicExample" class="table custom-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td><?=$t->UPTD?></td>
                            <td>
                                <a href="<?= base_url('Admin/Kecamatan/form_edit_ppembuang/' . $t->id) ?>" class="icon red" data-toggle="tooltip" data-placement="top" title="Edit Bendung"><i class="icon-edit"></i></a>
    ...
    <script>
        ...
        function poppembuang1(f,l){
            ...
            if (f.properties){
                out.length = 0;
                out.push('Nama : '+f.properties['BANGUNAN']);
               
                out.push("<center><a style='color: white' class='btn btn-block btn-success btn-sm' href='<?=base_url("Admin/Kecamatan/form_edit_ppembuang/")?>"+f.properties['id']+"'  target='_blank'>"+'EDIT'+"</a></center>");
