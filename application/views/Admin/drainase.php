                ...
                <table id="basicExample" class="table custom-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('Admin/Kecamatan/form_edit_drainase/' . $t->id) ?>" class="icon red" data-toggle="tooltip" data-placement="top" title="Edit Bendung"><i class="icon-edit"></i></a>
    ...
    <script>
        ...
        function popsaluranpembuang1(f,l){
            ...
            if (f.properties){
                ...
                out.push("<center><a style='color: white' class='btn btn-block btn-success btn-sm' href='<?=base_url("Admin/Kecamatan/form_edit_drainase/")?>"+f.properties['id']+"'  target='blank'>"+'Edit'+"</a></center>");
