...
<form action="<?= base_url('Admin/Kecamatan/tambah_simpan_irigasi/' . $tabel[0]->id) ?>" method="POST" enctype="multipart/form-data">
                    <div class="row gutters">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <?php }elseif($key == 'NO_DI') { ?>
                                         ...
                                         <?php }elseif($key == 'Photo_Awal') { ?>
                                         <input type="file" class="form-control" id="<?= $key ?>" name="<?= $key ?>" value="">
                                         <?php }elseif($key == 'Photo_Ujun') { ?>
                                         <input type="file" class="form-control" id="<?= $key ?>" name="<?= $key ?>" value="">
