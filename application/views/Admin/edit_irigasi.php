...
<script src="https://cdn.jsdelivr.net/npm/@turf/turf@6.3.0/turf.min.js"></script>
            <form action="<?= base_url('Admin/Kecamatan/edit_simpan_irigasi/' . $tabel[0]->id.'/'.$tabel[0]->id_di) ?>" method="POST" enctype="multipart/form-data">
            <div class="row gutters">
                <?php
                        $tab = $tabel[0];
                        ...
                        ?>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group">
                                        <?php if ($key == 'Photo_Awal' || $key == 'Photo_Ujun') {?>
                                        <label for="inputName"><?= $key ?></label>
                                        <input type="file" class="form-control" id="<?= $key ?>" name="<?= $key ?>" value="<?= $value ?>">
                                        <?php } else{ ?>
                                         <label for="inputName"><?= $key ?></label>
