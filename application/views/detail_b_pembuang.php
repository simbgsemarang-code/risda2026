        ...
        <div class="row g-1">
            <div class="col-xl-5 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="about-item-content bg-white rounded p-5 h-100 py-2 g-1">
                    <h4 class="text-success">Detail Bangunan Pelengkap</h4>
                    <hr>
                    <div class="row g-5 mb-0">
                        ...
                        <div class="col-sm-7">
                             <p" class="d-inline-block  mb-1">: <?=$bendung1['NAME']?></p>
                        </div>
                    </div>
                    <div class="row g-5 mb-0">
                        <div class="col-sm-5 ">
                    ...
                    <div class="row g-5 mb-0">
                        <div class="col-sm-5">
                            <p" class="d-inline-block h6 mb-0">No SK</p>
                        </div>
                        <div class="col-sm-7">
                             <p" class="d-inline-block  mb-2">: <?=$bendung1['NO_SK']?> </p>
                        </div>
                    </div>
                    <div class="row g-5 mb-0">
                        <div class="col-sm-5">
                            <p" class="d-inline-block h6 mb-0">Bangunan</p>
                        </div>
                        <div class="col-sm-7">
                             <p" class="d-inline-block  mb-2">: <?=$bendung1['BANGUNAN']?> </p>
                        </div>
                    </div>
                    <div class="row g-5 mb-0">
                        <div class="col-sm-5">
                            <p" class="d-inline-block h6 mb-0">Keterangan</p>
                        </div>
                        <div class="col-sm-7">
                             <p" class="d-inline-block  mb-2" style=" font-size: 12px">: <?=$bendung1['KET']?> </p>
                        </div>
                    </div>
                    <div class="row g-5 mb-0">
                        <div class="col-sm-5">
                    ...
                    <div class="row g-5 mb-0">
                        ...
                        <div class="col-sm-7">
                            ...
                            $lng = $bendung1['POINT_X'];?>
                             <p" class="d-inline-block  mb-2" style=" font-size: 12px">: <?=$bendung1['Koordinat']?><a href="https://www.google.com/maps/search/?api=1&query=<?= $lat ?>,<?= $lng ?>" target="_blank"><img width="23px" src="<?= base_url('assets/images/direct.png') ?>"></a></p>
                        </div>
                    </div>
            ...
            <div class="col-xl-7 wow fadeInRight" data-wow-delay="0.2s">
                <div class="about-item-content bg-white rounded p-5 h-100 py-2 g-1">
                    <h4 class="text-success">
                        <center>Peta Bangunan Pelengkap <?=$bendung1['NAME']?>  </center>
                    </h4>
